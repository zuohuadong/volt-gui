...
npx tsx src/index.ts init --goal "<design goal>" --config "/Users/zhd/workspace/volt-voltui/.agents/goal-forge/goal-forge.config.json" --out "/Users/zhd/workspace/volt-voltui/.agents/goal-forge/runs/<run-id>"
```
...
```bash
cd "<path-to-sibling-goal-forge>"
npx tsx src/index.ts run "/Users/zhd/workspace/volt-voltui/.agents/goal-forge/runs/<run-id>" --rounds 1 --adapter local
npx tsx src/index.ts validate "/Users/zhd/workspace/volt-voltui/.agents/goal-forge/runs/<run-id>" --strict
```
...
```bash
cd "<path-to-sibling-goal-forge>"
npx tsx src/index.ts run "/Users/zhd/workspace/volt-voltui/.agents/goal-forge/runs/<run-id>" --rounds 1 --adapter codex --repo "/Users/zhd/workspace/volt-voltui" --model gpt-5.3-codex
```
