...
- **行业 skill**: 新增 `anyong-brand-config`、`cnb-ci-cd`、`volt-ai-ops` 三个 fork 专属 skill
...
- **volt 内部网关编译时默认值**: `ProviderEntry.APIKeyDefault` 字段，`APIKey()` 方法优先读环境变量，回退到编译时内嵌值，实现零配置部署
...
[desktop-v0.1.4]: https://cnb.cool/aizhuliren/volt/anyong-agent/-/releases/desktop-v0.1.4
[desktop-v0.1.3]: https://cnb.cool/aizhuliren/volt/anyong-agent/-/releases/desktop-v0.1.3
[desktop-v0.1.2]: https://cnb.cool/aizhuliren/volt/anyong-agent/-/releases/desktop-v0.1.2
[desktop-v0.1.1]: https://cnb.cool/aizhuliren/volt/anyong-agent/-/releases/desktop-v0.1.1
[desktop-v0.1.0]: https://cnb.cool/aizhuliren/volt/anyong-agent/-/releases/desktop-v0.1.0
[1.0.0-anyong]: https://cnb.cool/aizhuliren/volt/anyong-agent/-/releases/desktop-v0.1.0
