...
func main() {
	flag.Usage = func() {
		fmt.Fprintf(flag.CommandLine.Output(), "e2ebench — VoltUI end-to-end benchmark.\n\n")
	...
	bin := flag.String("bin", "voltui", "path to the voltui binary")
...
func render(results []result) string {
	...
	fmt.Fprintf(&b, "## 🤖 VoltUI e2e benchmark (%s)\n\n", profile)
