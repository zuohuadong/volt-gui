...
* add generation-safe runtime composition / 添加代际安全的运行时组合 ([d17f768](https://github.com/zuohuadong/volt-gui/commit/d17f768f4427bffed3acf6cc4e1c698221ffebf4))
...
* **agent:** add explicit context compression tool / 显式上下文压缩工具 ([a41465e](https://github.com/zuohuadong/volt-gui/commit/a41465e9bbc88814c64e6705ef692a06d4375316))
...
* **desktop:** add tps throughput, cache token counts, and output tokens to status bar / 底部信息栏新增 tps 吞吐、缓存 token 和输出 token 显示 ([69fab57](https://github.com/zuohuadong/volt-gui/commit/69fab575544252741b50daef71a3e515b7c1d1dd))
...
* **e2ebench:** overthinking damage rate — Correct→Incorrect as a headline metric ([14a0878](https://github.com/zuohuadong/volt-gui/commit/14a087810a249eb834930021fcf4cb583506780a))
...
* **goal:** make Goal the sole long-task runtime / Goal 成为唯一长任务状态机 ([677ca8d](https://github.com/zuohuadong/volt-gui/commit/677ca8db3892286f879456c757e65ceb0c186ee3))
* **mcp:** add sandbox-safe OAuth and failure-aware routing / 添加沙箱安全的 MCP OAuth 与失败路由 ([6c68927](https://github.com/zuohuadong/volt-gui/commit/6c68927728ed3a3d01bd3f9de27937c951fcdbe6))
...
* raise output budgets to 128K + cache-aware context projection / 提升输出预算与缓存感知惰性压缩 ([128b34b](https://github.com/zuohuadong/volt-gui/commit/128b34b63ba20c9ebad8ea3e75abde8774c62565))
...
* **taskcontract:** FromPlan and ExecutionView — Planner → Contract → Executor ([612c171](https://github.com/zuohuadong/volt-gui/commit/612c1715c0bf06a13c31eb6c461743d31bfc434b))
...
* **cli:** lifecycle TUI watchdog and Responses stream stall coverage / 生命周期 Watchdog 与流停滞覆盖 ([6bec06a](https://github.com/zuohuadong/volt-gui/commit/6bec06aeb56f5e7ee7bf13870bc5320860ec0151))
...
* **desktop:** restore edit actions for cancelled turns / 修复立即取消回合的编辑操作 ([cc2fd2f](https://github.com/zuohuadong/volt-gui/commit/cc2fd2fd2e8f45b73fcc6b9a7ca052fea1d376b0))
...
* **goal:** harden contextual tool and migration boundaries / Goal/context 工具与迁移边界完整修复 ([209a467](https://github.com/zuohuadong/volt-gui/commit/209a4673e0f0cb7f6a5f0223d5a323eda2c5ae40))
...
* **hooks:** normalize Windows POSIX scripts across hook sources / 修复 Windows 多来源 Hook 的 POSIX 脚本执行 ([6d7a7df](https://github.com/zuohuadong/volt-gui/commit/6d7a7dff8b620ee001886b3c6aebdcc144a1c8cb))
...
* **session:** make crash recovery WAL-aware and conflict-safe / 修复会话恢复回滚与并发覆盖 ([118d10c](https://github.com/zuohuadong/volt-gui/commit/118d10c44c61277a8e388f7ce604b9c878c184c2))
...
* **update:** self-heal stuck pending updates / 自愈卡住的待更新事务 ([c428f91](https://github.com/zuohuadong/volt-gui/commit/c428f9166cbd0a227a2712967f84123d548ee9df))
...
* **release:** track Windows CI portability fix / 记录 Windows CI 兼容修复 ([3f7dbff](https://github.com/zuohuadong/volt-gui/commit/3f7dbfff0c01a2ae878c78bbcf7c02f06e1c20de))
* **release:** 准备 v1.21.1 中英更新日志 ([2acea4c](https://github.com/zuohuadong/volt-gui/commit/2acea4c87308513739921507972d8fd47273ba66))
* **release:** 准备 v1.21.2 中英更新日志 ([fda4b7a](https://github.com/zuohuadong/volt-gui/commit/fda4b7a857e012a3a248de8a8ac790452935bad7))
* **release:** 准备 v1.21.2 中英更新日志 ([27af987](https://github.com/zuohuadong/volt-gui/commit/27af9878acd1f935a5a714660d9924d211090c8c))
* **release:** 准备 v1.21.2 中英更新日志 ([23f4dd6](https://github.com/zuohuadong/volt-gui/commit/23f4dd6e5728bd8fb689ace2a59c7417a98dc174))
* **release:** 准备 v1.21.2 中英更新日志 ([ebd1ee4](https://github.com/zuohuadong/volt-gui/commit/ebd1ee463b44b4962cc97412e1e32af17fc11dcb))
* **release:** 准备 v1.21.2 中英更新日志 ([97b1dc0](https://github.com/zuohuadong/volt-gui/commit/97b1dc057ff7ef6a796df33940fcbade6d7e120d))
* **release:** 准备 v1.21.2 中英更新日志 ([c1d7c9e](https://github.com/zuohuadong/volt-gui/commit/c1d7c9ec1780888b4264fb8d71a8448ac8cc8330))
* **release:** 准备 v1.21.2 中英更新日志 ([0231c0e](https://github.com/zuohuadong/volt-gui/commit/0231c0e27eee29b36dd49d7236acdf605e3be3ea))
* **release:** 准备 v1.21.4 中英更新日志 ([87c2be2](https://github.com/zuohuadong/volt-gui/commit/87c2be276a5d0c0fd09489c0265f51193ba1d0ca))
...
* Add deterministic planner routing and depth / 增加确定性规划路由与深度 ([#6918](https://github.com/zuohuadong/volt-gui/issues/6918)) ([aa8c97f](https://github.com/zuohuadong/volt-gui/commit/aa8c97f75effea3e95c1bb02064d4cdfa40bdf96))
...
* **desktop:** add bounded regex search to code previews / 为代码预览添加有界正则搜索 ([#6923](https://github.com/zuohuadong/volt-gui/issues/6923)) ([cb8dcdc](https://github.com/zuohuadong/volt-gui/commit/cb8dcdc1f7811fc4edc58966950de7f1bf8b2b18))
...
* **desktop:** add native crash diagnostics / 增加桌面原生崩溃诊断 ([#6900](https://github.com/zuohuadong/volt-gui/issues/6900)) ([4b2ef3d](https://github.com/zuohuadong/volt-gui/commit/4b2ef3dabbf07097d3707cd9e3c161e560b03f2b))
...
* **build:** complete main-v2 convergence to restore module build ([97894d6](https://github.com/zuohuadong/volt-gui/commit/97894d679ce7cadc2677b0a8bce6162b0f6b9ecf)), closes [#64](https://github.com/zuohuadong/volt-gui/issues/64)
...
* **desktop:** fix code preview line-number alignment and redesign search bar / 修复代码预览行号对齐并重构搜索栏 ([#6910](https://github.com/zuohuadong/volt-gui/issues/6910)) ([a3e0f10](https://github.com/zuohuadong/volt-gui/commit/a3e0f10be45b34ff6f8b2c36a19f0634e20d28b4))
...
* **desktop:** paste text undoable via Ctrl+Z on Windows ([#6531](https://github.com/zuohuadong/volt-gui/issues/6531)) / 修复ctrl+z无法撤回ctrl+v的内容 ([#6571](https://github.com/zuohuadong/volt-gui/issues/6571)) ([acdef99](https://github.com/zuohuadong/volt-gui/commit/acdef9998aee5498bfac5602e610e77683ca059f))
...
* Detect requests containing only read-only work terms and route bounded non-ambiguous cases directly to the executor. Preserve full planning for high-risk, cross-surface, structured, complex, or ambiguous read-only work, and prioritize ambiguous scope over an anchored target. Update English/Chinese docs and the routing matrix. ([aa8c97f](https://github.com/zuohuadong/volt-gui/commit/aa8c97f75effea3e95c1bb02064d4cdfa40bdf96))
...
* **skill,tool:** complete post-write receipt and skill invocation gaps from upstream ([046be1b](https://github.com/zuohuadong/volt-gui/commit/046be1b93edd0fcc746157473a7fe702011b4187))
* Start the deadline before worker creation, scan regex requests against the full source with line anchors preserved, and surface explicit localized errors for newline-spanning matches. Add regression coverage for both paths. ([cb8dcdc](https://github.com/zuohuadong/volt-gui/commit/cb8dcdc1f7811fc4edc58966950de7f1bf8b2b18))
...
* reapply subsystem strip-down over main-v2 convergence ([4be4b6f](https://github.com/zuohuadong/volt-gui/commit/4be4b6fcd5e7b0a7fdb3f4b971a4ccd900105b75))
* strip legacy subsystems and migrate desktop frontend to Svelte ([80ac098](https://github.com/zuohuadong/volt-gui/commit/80ac0989f5eb475968691d3a85279062360551ca))
