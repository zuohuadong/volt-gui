...
func TestGenManifestForkBrand(t *testing.T) {
	dir := t.TempDir()
	releasePage := "https://cnb.cool/aizhuliren/volt/anyong-agent/-/releases"
	assetBase := "https://cnb.cool/aizhuliren/volt/anyong-agent/-/releases/download/desktop-v0.8.0"
	names := []string{
