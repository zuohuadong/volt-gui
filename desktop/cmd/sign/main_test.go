...
func TestGenManifestUsesReleaseURLOverrides(t *testing.T) {
	...
	t.Setenv("RELEASE_DOWNLOAD_PAGE", "https://cnb.cool/aizhuliren/volt/anyong-agent/-/releases/desktop-v1.2.0")
	t.Setenv("RELEASE_ASSET_BASE_URL", "https://cnb.cool/aizhuliren/volt/anyong-agent/-/releases/desktop-v1.2.0/downloads")
	...
	wantURL := "https://cnb.cool/aizhuliren/volt/anyong-agent/-/releases/desktop-v1.2.0/downloads/" + name
	if windows.URL != wantURL {
		t.Fatalf("windows url = %q, want %q", windows.URL, wantURL)
	}
	if m.DownloadPage != "https://cnb.cool/aizhuliren/volt/anyong-agent/-/releases/desktop-v1.2.0" {
