...
export const en = {
  ...
  "caps.failureHint": "Connected servers still work. Details stay tucked away until you need to troubleshoot.",
  "caps.failureGroups": "Issue types",
  "caps.failureCollapsed": "{count} issues are collapsed and do not block the usable MCPs below.",
