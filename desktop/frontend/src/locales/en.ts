...
export const en = {
  ...
  "heartbeat.noTasks": "No heartbeat tasks yet. Click \"Add task\" to create one.\n\nTip: AI agents can also edit the config file at ~/.reasonix/heartbeat-tasks.json",
  ...
  "heartbeat.configHint": "AI agents can also edit ~/.reasonix/heartbeat-tasks.json directly.",
