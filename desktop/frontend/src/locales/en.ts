...
export const en = {
  ...
  "welcome.creation.titlePrimary": "Hello, what are we building today?",
  "welcome.creation.titleSecondary": "Start with one task.",
  "welcome.creation.explainTitle": "Explain the code architecture",
  "welcome.creation.explainBody": "Trace modules and key links.",
  "welcome.creation.gitTitle": "Summarize Git changes",
  "welcome.creation.gitBody": "Review changes and risk points.",
  "welcome.creation.bugTitle": "Fix a Bug",
  "welcome.creation.bugBody": "Locate the issue and verify the patch.",
