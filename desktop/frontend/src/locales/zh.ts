...
export const zh: Record<DictKey, string> = {
  ...
  // 输入框
  "composer.placeholder": "给 {name} 发消息…  ( / 命令 · @ 文件 )",
  ...
  "memory.noDocs": "未找到 VOLTUI.md。可在上方快速添加一条。",
  ...
  "settings.closeBehavior.quit": "退出 {name}",
  ...
  "onboarding.title": "连接 {name}",
  "onboarding.tagline": "粘贴一个 API key 即可开始。密钥仅存于本应用的本地凭据文件，不会发往任何地方。",
  ...
  "mock.askQ2Header": "{name} 构建",
  "mock.askQ2Prompt": "对于 voltui 二进制缺失的问题，你想怎么做？",
