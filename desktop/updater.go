...
const (
	...
	manifestFallback    = "https://cnb.cool/aizhuliren/volt/anyong-agent/-/releases/latest/downloads/latest.json"
	defaultDownloadPage = "https://cnb.cool/aizhuliren/volt/anyong-agent/-/releases"
