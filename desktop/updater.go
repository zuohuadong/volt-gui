...
const (
	r2Base             = "https://dl.voltui.io"
	releaseGatewayBase = "https://crash.voltui.io/v1/desktop/releases"
	downloadPageURL    = "https://voltui.io/#start"
	httpTimeout        = 15 * time.Second
)

// githubManifestFallback is the stable channel's last-resort manifest source.
// dl.voltui.io and crash.voltui.io share one Cloudflare zone, so bot
