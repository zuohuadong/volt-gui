...
legacy desktop shell. It is intentionally product-facing: a feature is complete only when
...
| Packaging | Production build | work, code | complete | `pnpm --dir desktop/frontend build` builds the Svelte 5 workbench directly into `desktop/frontend/dist`, and the desktop Go package compiles against that embedded output. The legacy shell has been removed. |

The legacy desktop shell has been removed. The Svelte 5 workbench is the sole frontend.
