...
func Default() *Config {
	return &Config{
		...
		Providers: []ProviderEntry{
			{Name: "qwen-thinking", Kind: "openai", BaseURL: "http://192.168.1.47:9010/v1", Model: "qwen-gpu4/step3p7-flash", APIKeyEnv: "volt_API_KEY", ContextWindow: 131_072, SupportedEfforts: []string{"high", "max"}, DefaultEffort: "high"},
