...
func Default() *Config {
	return &Config{
		...
		Providers: []ProviderEntry{
			...
			// API key 编译期内置，无需用户配置；仍可通过 volt_API_KEY 环境变量覆盖。
			{Name: "qwen-gpu4", Kind: "openai", BaseURL: "http://192.168.1.47:9010/v1", Model: "qwen-gpu4/qwen36-opus-prisma8-gpu4", APIKeyEnv: "volt_API_KEY", APIKeyDefault: "[REDACTED_SECRET]", ContextWindow: 131072, NoProxy: true},
			{Name: "glm-primary", Kind: "openai", BaseURL: "http://192.168.1.47:9010/v1", Model: "glm-primary/GLM-5.1-478B-A42B-REAP-NVFP4", APIKeyEnv: "volt_API_KEY", APIKeyDefault: "[REDACTED_SECRET]", ContextWindow: 131072, NoProxy: true},
			{Name: "qwen-gpu5", Kind: "openai", BaseURL: "http://192.168.1.47:9010/v1", Model: "qwen-gpu5/qwen36-opus-prisma8-gpu5", APIKeyEnv: "volt_API_KEY", APIKeyDefault: "[REDACTED_SECRET]", ContextWindow: 131072, NoProxy: true},
			{Name: "image-gpu5", Kind: "openai", BaseURL: "http://192.168.1.47:9010/v1", Model: "image-gpu5/image-gpu5", APIKeyEnv: "volt_API_KEY", APIKeyDefault: "[REDACTED_SECRET]", ContextWindow: 131072, NoProxy: true},
		},
	}
}
