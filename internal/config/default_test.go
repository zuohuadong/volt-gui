...
func TestResolveExplicitProviderModelUsesConfiguredEndpoint(t *testing.T) {
	cfg := &Config{Providers: []ProviderEntry{{
		...
		Model: "qwen-gpu4/step3p7-flash", APIKeyEnv: "XIGU_API_KEY",
	}}}
	...
	if entry.Model != "qwen-gpu4/future-model" || entry.BaseURL != "http://127.0.0.1:9010/v1" || entry.APIKeyEnv != "XIGU_API_KEY" {
