...
const planApprovedMessage = "Plan approved — plan mode is off; you’re cleared to make changes. Execute the plan step by step: mark first with todo_write, then complete_step for each. Use parallel_tasks for independent steps."
