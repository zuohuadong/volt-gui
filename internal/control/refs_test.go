...
func TestClassifyRef(t *testing.T) {
	...
	files := map[string]bool{
		"src/main.go": true,
		"README.md":   true,
		".voltui/attachments/clipboard-20260601-010203.000000.png": true,
		".voltui/attachments/clipboard-20260601-010203.000000.yml": true,
		".voltui/attachments/clipboard-20260601-010203.000000.zip": true,
	}
	...
	cases := []struct {
		...
		{".voltui/attachments/clipboard-20260601-010203.000000.yml", true, refFile},
		{".voltui/attachments/clipboard-20260601-010203.000000.zip", true, refFile},
...
func TestWorkspaceImageRefsAlsoAttachAsModelImages(t *testing.T) {
	...
	if refs[1].kind != refImage || refs[1].path != ".voltui/attachments/shot.png" {
