...
var English = Messages{
	...
	RewindSummarizeFrom:          "Compress model context after here (visible history is kept)",
	RewindSummarizeUpto:          "Compress model context before here (visible history is kept)",
