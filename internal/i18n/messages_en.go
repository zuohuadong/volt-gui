...
var English = Messages{
	...
	ConfigWriteReason:                      "This write targets a VoltUI-managed configuration file outside the workspace. It can change providers, sandbox rules, permissions, and MCP servers for future sessions, so it needs your explicit approval.",
	ConfigWriteDeclined:                    "the user declined this VoltUI config write - do not retry it; ask how they would like to proceed.",
