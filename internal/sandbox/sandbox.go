...
// writable roots (workspace, Reasonix user config dir, configured extras, plus
// temp and toolchain caches) and reach the network only when allowed. This is
// the *enforcement* layer beneath the permission rules
