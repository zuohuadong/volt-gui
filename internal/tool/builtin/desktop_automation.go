...
func (desktopScreenshot) SnipHint() tool.SnipHint {
	return tool.SnipHint{Head: 4, Tail: 1, HeadChars: 1000, TailChars: 100}
}
...
func (desktopMouse) SnipHint() tool.SnipHint {
	return tool.SnipHint{Head: 4, Tail: 1, HeadChars: 1000, TailChars: 100}
}
...
func (desktopKeyboard) SnipHint() tool.SnipHint {
	return tool.SnipHint{Head: 4, Tail: 1, HeadChars: 1000, TailChars: 100}
}
