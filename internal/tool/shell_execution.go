...
type ShellExecution struct {
	...
	StderrTail   string `json:"stderrTail,omitempty"`   // at most 16 KiB; no shell executable absolute path
...
// StderrTailMaxBytes bounds stderr retained on ShellExecution.
