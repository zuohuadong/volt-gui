...
description: Use when configuring, verifying, or debugging the 西谷智灯暗涌系统 (Anyong/volt AI) white-label branding on the VoltUI fork. Covers Go BrandConfig, Electron runtime brand environment variables, and GitHub Actions/CNB build behavior.
---
