...
description: Use when configuring, verifying, or debugging the 暗涌 (Anyong/volt AI) white-label branding on the VoltUI fork. Covers BrandConfig env vars, voltui.toml [brand] section, desktop-build.sh VOLTUI_BRAND_NAME, and GitHub Actions/CNB release naming.
---
...
2. ✅ `.cnb.yml` sets `volt_BRAND_NAME: "暗涌"` — correct
