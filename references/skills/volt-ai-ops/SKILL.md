---
name: volt-ai-ops
description: Use when tasks involve 西谷AI (volt AI) internal operations, 暗涌 product strategy, Chinese AI market context, local regulations, or fork-specific workflow decisions. Covers upstream sync strategy, release workflow, internal tooling, and product-market-fit decisions for the 暗涌 coding agent.
---

# 西谷AI / 暗涌运营技能

此技能覆盖西谷AI (volt AI) 的内部运营决策、暗涌产品策略和中国AI市场背景。
