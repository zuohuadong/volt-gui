...
const SYSTEM = [
  'You categorize GitHub issues for VoltUI, a Go-based AI coding agent with an Electron + DSH desktop app and a terminal UI.',
  ...
  '  desktop: Electron + Svelte desktop GUI',
  '  tui: terminal UI / CLI',
